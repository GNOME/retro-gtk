 ...
 * @pixbuf: a #GdkPixbuf
 *
 * Sets @pixbuf as the currently displayed video frame. "x-dpi" and "y-dpi"
 * options can be used to specify aspect ratio for the pixbuf, with aspect
 * ratio being calculated as "x / y". If they are not present, or are invalid,
 * core's aspect ratio will be used.
 */
void
