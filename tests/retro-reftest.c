                    ...
                    char ***argv)
{
  ...
  if (arg_skip < 0) {
    g_printerr ("Invalid argument passed to --skip argument. It numst be a positive integer.\n");
    arg_skip = 0;
  }
...
retro_reftest_generate_video (RetroReftest *reftest)
{
   ...
   * description of used keys. "Game Title" and "Platform" are non-standard
   * fields as allowed by PNG specification.
   */
