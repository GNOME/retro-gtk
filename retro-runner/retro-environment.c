...
#define RETRO_UNIMPLEMENTED_ENVIRONMENT(cmd) \
  case cmd: \
    G_STMT_START { \
                          ...
                          gpointer   data)
{
  ...
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_AUDIO_VIDEO_ENABLE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_CAMERA_INTERFACE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_CORE_OPTIONS_VERSION);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_CURRENT_SOFTWARE_FRAMEBUFFER);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_DISK_CONTROL_INTERFACE_VERSION);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_FASTFORWARDING);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_GAME_INFO_EXT);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_HW_RENDER_INTERFACE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_INPUT_BITMASKS);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_INPUT_MAX_USERS);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_LED_INTERFACE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_LOCATION_INTERFACE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_MESSAGE_INTERFACE_VERSION);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_MIDI_INTERFACE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_PERF_INTERFACE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_PREFERRED_HW_RENDER);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_SENSOR_INTERFACE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_TARGET_REFRESH_RATE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_GET_VFS_INTERFACE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_AUDIO_BUFFER_STATUS_CALLBACK);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_AUDIO_CALLBACK);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_CONTENT_INFO_OVERRIDE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_CONTROLLER_INFO);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_CORE_OPTIONS);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_CORE_OPTIONS_DISPLAY);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_CORE_OPTIONS_INTL);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_DISK_CONTROL_EXT_INTERFACE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_FASTFORWARDING_OVERRIDE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_FRAME_TIME_CALLBACK);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_HW_RENDER_CONTEXT_NEGOTIATION_INTERFACE);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_HW_SHARED_CONTEXT);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_MEMORY_MAPS);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_MESSAGE_EXT);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_MINIMUM_AUDIO_LATENCY);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_PERFORMANCE_LEVEL);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_PROC_ADDRESS_CALLBACK);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_SERIALIZATION_QUIRKS);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_SUBSYSTEM_INFO);
  RETRO_UNIMPLEMENTED_ENVIRONMENT (RETRO_ENVIRONMENT_SET_SUPPORT_ACHIEVEMENTS);
